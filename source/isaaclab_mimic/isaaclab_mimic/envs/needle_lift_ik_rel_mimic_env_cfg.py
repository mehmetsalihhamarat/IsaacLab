...
from isaaclab_tasks.manager_based.manipulation.lift_psm.config.ik_rel_env_cfg import NeedleLiftEnvCfg


@configclass
class NeedleLiftIKRelMimicEnvCfg(NeedleLiftEnvCfg, MimicEnvCfg):
    """
